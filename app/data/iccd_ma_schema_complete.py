"""
Scheda ICCD MA 3.00 - Monumenti Archeologici COMPLETA
Conforme a normativa ufficiale ICCD MiC 2025

Basato su:
- ICCD_MA_3.00.xls (normativa ufficiale)
- ICCD_Le-schede-CA-e-MA_Complessi-e-monumenti-archeologici_vers3.00.pdf

Ambito: Monumenti archeologici costituiti da singole unità edilizie
Esempi: tempio, domus, teatro, anfiteatro, villa unifamiliare

Paragrafi obbligatori: CD, OG, LC, DT, MT, DA, TU, DO, AD, CM
MA ha la STESSA struttura di CA ma per unità edilizie singole
...
def get_iccd_ma_300_schema() -> Dict[str, Any]:
    """
    Schema MA 3.00 COMPLETO - Monumenti Archeologici

    Ambito: Catalogazione monumenti archeologici
    - Architettura compiuta costituita da singola unità edilizia
    - Tempio, domus, teatro, anfiteatro, basilica
    - Villa unifamiliare, casa, edificio termale
    - A prescindere dall'attuale stato di conservazione
    """

    return {
        "id": "iccd_ma_300",
        "name": "MA 3.00 - Monumenti Archeologici",
        "version": "3.00",
        "category": "archaeological_monument",
...
def _get_cd_schema() -> Dict[str, Any]:
    ...
    return {
        ...
        "title": "CD - CODICI",
        "properties": {
            "TSK": {"type": "string", "const": "MA", "maxLength": 4},
            "LIR": {
                "type": "string",
                "enum": ["P", "I", "C", "A"],
...
def _get_rv_schema() -> Dict[str, Any]:
    ...
    return {
        "type": "object",
        "title": "RV - RELAZIONI",
        "description": "Gestione relazioni gerarchiche per monumenti",
        "properties": {
            "RVE": {
                "type": "array",
                "title": "STRUTTURA COMPLESSA",
                "description": "Es: domus (madre) composta da: atrio (figlia 1), tablinum (figlia 2), peristilio (figlia 3)",
                "items": {
                    "type": "object",
                    "properties": {
                        "RVEL": {
...
def _get_og_schema() -> Dict[str, Any]:
    ...
    return {
        "type": "object",
        "title": "OG - OGGETTO",
        "description": "Identificazione tipologica e funzionale del monumento",
        "properties": {
            "OGT": {
                "type": "object",
                "title": "OGGETTO",
                "properties": {
                    "OGTD": {
                        "type": "string",
                        "title": "Definizione",
                        "description": "Da vocabolario ICCD monumenti archeologici",
                        "examples": [
                            "tempio", "domus", "teatro", "anfiteatro",
                            "villa", "casa", "edificio termale", "basilica",
                            "ninfeo", "cisterna", "pozzo", "fontana"
                        ]
                    },
                    "OGTC": {
                        "type": "string",
                        ...
                        "enum": [
                            ...
                            "EDIFICIO TERMALE",
                            "EDIFICIO/STRUTTURA PER IL CULTO",
...
def _get_lc_schema() -> Dict[str, Any]:
    ...
    return {
        ...
        "description": "Dove si trova il monumento al momento della catalogazione",
        "properties": {
            "PVC": {
                "type": "object",
...
def _get_gp_schema() -> Dict[str, Any]:
    ...
    return {
        ...
        "description": "Per monumenti rappresentabili con coordinate puntuali",
        "properties": {
            "GPL": {
                "type": "string",
...
def _get_gl_schema() -> Dict[str, Any]:
    ...
    return {
        ...
        "description": "Per monumenti che si sviluppano lungo una linea (es: acquedotto)",
        "properties": {
            "GLL": {
                "type": "string",
                "title": "Tipo localizzazione",
...
def _get_ga_schema() -> Dict[str, Any]:
    ...
    return {
        ...
        "description": "Per monumenti con estensione areale (es: grande villa)",
        "properties": {
            "GAL": {
                "type": "string",
                "title": "Tipo localizzazione",
...
def _get_re_schema() -> Dict[str, Any]:
    ...
    return {
        ...
        "description": "Indagini che hanno interessato il monumento",
        "properties": {
...
def _get_dt_schema() -> Dict[str, Any]:
    ...
    return {
        "type": "object",
        "title": "DT - CRONOLOGIA",
        "description": "Cronologia della costruzione e delle fasi del monumento",
        "properties": {
            "DTZ": {
                "type": "array",
    ...
    return {
        ...
        "properties": {
            "DES": {
                ...
                "properties": {
                    "DESO": {
                        ...
                        "title": "Descrizione",
                        "minLength": 50,
                        "description": "Descrizione generale del monumento"
                    }
                },
                "required": ["DESO"]
            },
            "FNS": {
                "type": "array",
                "title": "FASI",
                "description": "Fasi cronologiche del monumento",
                "items": {
                    "type": "object",
                    "properties": {
...
def _get_ui_schema() -> Dict[str, Any]:
    ...
    return {
        ...
        "OG": {
            "OGT": {
                "OGTC": {"ui:help": "Categoria principale del monumento"},
...
# - MA: Singole unità edilizie (tempio, domus, teatro)
# - Stessa struttura dati, diverse definizioni di oggetto
# - MA può avere parent CA o SI, RA può avere parent CA/MA/SI